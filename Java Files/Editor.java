 ...
 public void saveAs()                                        //Save As Function
{
  ...
  //  System.out.println(fileName+"\n"+newFile+"\n"+path+"\n"+pass);
   ...
   public void printText()
     {
        ImageIcon icon=new ImageIcon("G:\\Programming\\Projects\\Editor\\Icon\\smile.png");
        JOptionPane.showMessageDialog(f,"Bhaiya Pehle Printer To Lagale","Message",JOptionPane.ERROR_MESSAGE,icon);
     }
